...
export class newSwotAnalysisComponent {
    ...
    saveNewProjectCall() {
        ...
        data =  {'author_id': this.user.id, 'project_name': this.project_name, 'project_content': JSON.stringify(this.gridElements), 'project_created': dd + ' ' + dt,'project_type': 'swot', 'project_expanded': localStorage.getItem('project_expanded')};
